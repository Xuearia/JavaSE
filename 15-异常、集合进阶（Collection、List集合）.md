...
![|](img/15/1666154871520.png)

第一感觉是这些集合好多呀！但是，我们学习时会对这些集合进行分类学习，如下图所示：一类是单列集合元素是一个一个的，另一类是双列集合元素是一对一对的。

![|](img/15/1666154948620.png)

在今天的课程中，<font color="#c0504d">主要学习Collection单列集合</font>。Collection是单列集合的根接口，Collection接口下面又有两个子接口List接口、Set接口，List和Set下面分别有不同的实现类，如下图所示：

![1666155169359|875](img/15/1666155169359.png)

上图中各种集合的特点如下图所示：

![1666155218956|875](img/15/1666155218956.png)
...
![](img/15/1666162606524.png)

最后，我们再总结一下，使用迭代器遍历集合用到哪些方法

![](img/15/1666162899638.png)
...
![](img/15/1666165150752.png)

### 4.1 List集合的常用方法

List集合是索引的，所以多了一些有索引操作的方法，如下图所示：

![](img/15/1666165187815.png)
